      ...
      <div className="z-10 w-full max-w-md bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-8 text-center border-4 border-rose-100 transform transition-all relative my-8">
        ...
        {step === 'entry' && (
          <div className="space-y-8 animate-in fade-in zoom-in duration-500">
            ...
            <p className="text-rose-400">Ecris ton petit nom en dessous stp...</p>
        ...
        {step === 'asking' && (
          <div className="space-y-8 animate-in fade-in zoom-in duration-700">
            <div className="relative inline-block">
              <img 
                src={noStage > 2 ? "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExOHpueG5zNms1Z3p6bjI4Ym9uOHR3Nnhicm5vNHBwaHNpbmxmd3p6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/OPU6wUKARA8QE/giphy.gif" : "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExM3Z0dzRndm9uOHR3Nnhicm5vNHBwaHNpbmxmd3p6bjI4Ym9uOHR3NiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/v8Yf3fHIdvH_320D9k/giphy.gif"} 
                alt="Reaction Bear" 
                className="w-48 h-48 mx-auto rounded-full object-cover border-4 border-rose-200 shadow-lg transition-all duration-500"
              />
        ...
        {step === 'success' && (
          <div className="space-y-6 animate-in zoom-in slide-in-from-bottom duration-1000">
            <div className="relative pb-4">
              <img 
                src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNnhybmU4enBxc3Z0ZzR3Nnhicm5vNHBwaHNpbmxmd3p6bjI4Ym9uOHR3NiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/iCVz2SSs1f9VsfM641/giphy.gif" 
                alt="Happy Valentine" 
                className="w-40 h-40 mx-auto rounded-full object-cover border-4 border-green-200 shadow-xl"
              />
